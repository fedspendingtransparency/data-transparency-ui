...
<Preview>
    <Story name='New Table Styles'>
        <TableWrapper columns={[
            { title: 'name',  displayName: 'Agency  Name' },
            { title: 'total',  displayName: 'Total Budgetary  Resources' },
            { title: 'Q4',  displayName: 'FY 2020 Q4', columnSpan: "2", subColumnNames: [{ name: 'P10', fieldName: 'P10'}, { name: 'P11', fieldName: 'P11' }] }
        ]}>
            <Table
                classNames="agency-reporting"
                rows={[
                    [<a href="/">Department of the Treasury (TREAS)</a>, 'mock data', '25%', '26%'],
                    [<React.Fragment><strong>jsx</strong> content</React.Fragment>, 1234, 'mock data', 'mock data IIIIIIIII']
                ]} />
        </TableWrapper>
    </Story>
</Preview>
