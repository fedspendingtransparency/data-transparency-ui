...
### Steps to implement
- Pass the property `header: true` to the first element of the columns property.
    ...
    <Story name='Table with First Column Headers'>
        <div className="story__container table-story">
            <Table
                ...
                rows={[
                    [{ displayName: 'Header', title: '', rowSpan: '0' }, <a href="/">Link</a>, 'mock data', '25%'],
                    [{ displayName: 'Other Header', title: '', rowSpan: '0' }, <React.Fragment><strong>jsx</strong> content</React.Fragment>, 1234, 'mock data']
                ]} />
        </div>
    </Story>
</Preview>

## Table with Last Column Headers

### Steps to implement
- Pass the property `header: true` to the last element of the columns property.
- Pass the property `rowSpan: '0'` to the last element of each of the rows property.

<Preview>
    <Story name='Table with Last Column Headers'>
        <div className="story__container table-story">
            <Table
                columns={
                    [
                ...
                rows={[
                    [<a href="/">Link</a>, 'mock data', '25%', { displayName: 'Header', title: '', rowSpan: '0' }],
                    [<React.Fragment><strong>jsx</strong> content</React.Fragment>, 1234, 'mock data', { displayName: 'Other Header', title: '', rowSpan: '0' }]
                ]} />
          </div>
    </Story>
</Preview>
