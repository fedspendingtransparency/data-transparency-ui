...
import { withKnobs, array, object, text, select } from "@storybook/addon-knobs";
    ...
    <Story name='Default'>
        <PickerWrapper>
            <Picker
                ...
                borderColor={text('borderColor', 'black')}
                borderType={select('borderType', ['bottom', 'none', 'full'], 'bottom', '')}
                iconSize={select('iconSize', ['xs', 'lg', 'sm', '1x', '2x', '3x', '4x', '5x', '6x', '7x', '8x', '9x', '10x'], 'lg', '')}
                optionPrefix={text('optionPrefix', 'Prefix Applied to Each Option')}
                options={array('options', ['number 1', 'number 2', 'some longer text', 'number 4'])} />
        </PickerWrapper>
    </Story>
</Preview>
