...
For more detail, see the USASpending Design System [Card Documentation](https://figma-gov.com/design/Kg3hJpzFI0XRXY5Irk8e57/USAS-%E2%80%93-Design-System?node-id=0-13720&t=VaRLbNN7sYCgvoio-0).

A Card is composed of a Card Container Component and any combination of three child components: The Card Body, Card Button and Card Hero.  The card also includes other text elements specific to the USASpending Design System.  Please see the [Card Anatomy](https://figma-gov.com/design/Kg3hJpzFI0XRXY5Irk8e57/USAS-%E2%80%93-Design-System?node-id=0-13782&t=1H4iNeFxLWbyMEO9-4).
