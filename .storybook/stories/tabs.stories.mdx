...
### Other props:
 - `counts`: An array of count objects
 - `disabled`: Is the tab disabled
 - `hideCounts`: should we hide the counts
...
<Preview>
    <Story name='Tabs with Counts'>
      <TabsWrapper>
        ...
        counts={{ name: 101, dates: 1002 }}
        hideCounts={boolean('hideCounts', false)} />
      </TabsWrapper>
    </Story>
</Preview>
